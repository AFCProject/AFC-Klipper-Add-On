...
class afcBoxTurtle(afcUnit):
    ...
    def handle_connect(self):
        ...
        self.logo_error+='R |_|_|__|_|_|\n'
        self.logo_error+='R |          \____\n'
        self.logo_error+='O |       _       🯔\n'
        self.logo_error+='R \______/  🯒    <span class=secondary--text>X</span>🯖 \n'
        self.logo_error+='!            🮡────🮠</span>\n'
